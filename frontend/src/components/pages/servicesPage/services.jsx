...
const ServicesPage = () => {
  ...
  const whyChooseUs = [
    {
      ...
      description: "Our developers have won multiple industry awards and recognition for exceptional work."
    },
    {
      icon: <Clock size={30} />,
    ...
    },
    {
      ...
      description: "Your data and code are protected with enterprise-grade security measures."
    },
    {
      icon: <Users size={30} />,
      title: "500+ Happy Clients",
      description: "Join hundreds of satisfied clients who trust us with their digital transformation."
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "We dive deep into your business requirements, goals, and target audience to create the perfect strategy."
    },
    {
      number: "02", 
      title: "Planning & Design",
      description: "Detailed project planning with wireframes, mockups, and technical specifications for your approval."
    },
    {
      number: "03",
      title: "Development & Testing", 
      description: "Agile development process with regular updates, rigorous testing, and quality assurance."
    },
    {
      number: "04",
      title: "Launch & Support",
      description: "Smooth deployment, comprehensive training, and ongoing support to ensure your success."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Professional Web Development Services | SoftRanch - Expert Frontend, Backend & Full Stack Development</title>
        <meta name="description" content="Transform your business with SoftRanch's professional web development services. Specializing in React, Node.js, SEO optimization, e-commerce solutions, and mobile app development. 500+ satisfied clients worldwide." />
        <meta name="keywords" content="web development services, react development, nodejs development, frontend development, backend development, full stack development, SEO optimization, e-commerce development, mobile app development, UI UX design" />
        <meta property="og:title" content="Professional Web Development Services | SoftRanch" />
        <meta property="og:description" content="Expert web development services including React, Node.js, SEO, and e-commerce solutions. Transform your business with our award-winning team." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://softranch.com/services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Professional Web Development Services | SoftRanch" />
        <meta name="twitter:description" content="Expert web development services including React, Node.js, SEO, and e-commerce solutions." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional web development services company specializing in React, Node.js, SEO optimization, and e-commerce solutions.",
      ...
      <div className="services-page-wrapper">
          ...
          <div className="services-page-container">
            <div className="services-page-hero-content">
              ...
              <p className="services-page-hero-description">
                From cutting-edge web applications to mobile solutions, our award-winning team delivers 
          ...
          <div className="services-page-container">
            <div className="services-page-section-header">
              ...
              <p className="services-page-section-subtitle">
                We offer end-to-end development solutions tailored to your business needs
              </p>
            </div>
            
            <div className="services-page-services-grid">
              {services.map((service, index) => (
                <article key={index} className="services-page-service-card" data-index={index}>
                  <div className={`services-page-service-icon-wrapper services-page-gradient-${index}`}>
                  ...
                  <div className="services-page-service-content">
                    <h3 className="services-page-service-title">{service.title}</h3>
                    <p className="services-page-service-description">{service.description}</p>
                    ...
                    <div className="services-page-service-meta">
                      <div className="services-page-service-pricing">
                        <span className="services-page-pricing-label">Starting at</span>
                        <span className="services-page-pricing-value">{service.pricing}</span>
                      </div>
        ...
        <section className="services-page-why-choose">
          <div className="services-page-container">
            <div className="services-page-section-header">
              <h2 className="services-page-section-title">Why Choose SoftRanch?</h2>
              <p className="services-page-section-subtitle">
            ...
            <div className="services-page-why-grid">
              {whyChooseUs.map((item, index) => (
                <div key={index} className="services-page-why-item">
                  <div className="services-page-why-icon">
                    {item.icon}
                  </div>
                  <h3 className="services-page-why-title">{item.title}</h3>
                  <p className="services-page-why-description">{item.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="services-page-process">
          ...
          <div className="services-page-container">
            <div className="services-page-section-header">
              <h2 className="services-page-section-title">Our Proven Development Process</h2>
              <p className="services-page-section-subtitle">
                A transparent, collaborative approach that ensures your project's success
              </p>
            </div>
            ...
            <div className="services-page-process-timeline">
              {processSteps.map((step, index) => (
                <div key={index} className="services-page-process-step">
                  <div className="services-page-process-number">{step.number}</div>
                  <div className="services-page-process-content">
                    <h3 className="services-page-process-title">{step.title}</h3>
                    <p className="services-page-process-description">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="services-page-testimonials">
          <div className="services-page-container">
            <div className="services-page-section-header">
              <h2 className="services-page-section-title">What Our Clients Say</h2>
              <p className="services-page-section-subtitle">
            ...
            <div className="services-page-testimonials-grid">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="services-page-testimonial-card">
                  <div className="services-page-testimonial-rating">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} size={16} className="services-page-star-filled" />
                    ))}
                  </div>
                  <p className="services-page-testimonial-text">"{testimonial.text}"</p>
                  <div className="services-page-testimonial-author">
                    <div className="services-page-author-info">
                      <h4 className="services-page-author-name">{testimonial.name}</h4>
                      <p className="services-page-author-company">{testimonial.company}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="services-page-container">
            <div className="services-page-cta-content">
              ...
              <div className="services-page-cta-buttons">
                ...
                <a target='_blank' href="https://wa.me/923355398908" className="services-page-cta-secondary">
                  Call Now: +92 335 5398908
                </a>
              </div>
              
              <div className="services-page-cta-guarantee">
                <Shield size={24} />
                <span>30-day money-back guarantee • Free consultation • No hidden fees</span>
              </div>
            </div>
          </div>
        </section>
