...
const HealthcareServices = () => {
  const features = [
    {
      ...
      description:
        "Secure online scheduling with automated reminders, insurance verification, and patient portal integration that reduces no-shows by 40%.",
    },
    {
      icon: <UserCheck size={32} />,
      title: "Patient Portal & Telehealth",
      description:
        "Secure patient portals with medical records access, prescription refills, and integrated telehealth capabilities for remote consultations.",
    },
    {
      icon: <MapPin size={32} />,
      title: "Medical SEO & Local Rankings",
      description:
        "Dominate 'doctors near me' searches with medical-specific SEO, Google My Business optimization, and healthcare directory listings.",
    },
    {
      icon: <Smartphone size={32} />,
      title: "Mobile-First Medical Design",
      description:
        "Responsive design optimized for patients on-the-go with fast loading, accessibility compliance, and intuitive navigation.",
    },
    {
      icon: <Shield size={32} />,
      title: "HIPAA Compliance & Security",
      description:
        "Bank-level security with SSL encryption, HIPAA-compliant forms, secure data transmission, and regular security audits.",
    },
    {
      icon: <FileText size={32} />,
      title: "Medical Content & Education",
      description:
        "Authoritative medical content, patient education resources, and condition-specific information that builds trust and expertise.",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "Our medical SEO and website optimization strategies consistently attract more qualified patients seeking your specialized care.",
    },
    {
      icon: <Clock size={24} />,
      title: "Reduce Administrative Burden",
      description:
        "Automated appointment booking, patient intake forms, and portal integration reduce staff workload by up to 60%.",
    },
    {
      icon: <Users size={24} />,
      title: "Enhanced Patient Experience",
      description:
        "Seamless online experience from appointment booking to follow-up care improves patient satisfaction and retention.",
    },
    {
      icon: <Heart size={24} />,
      title: "Build Medical Authority",
      description:
        "Establish yourself as a trusted healthcare expert with authoritative content and professional online presence.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Medical Website Development & HIPAA-Compliant Patient Portals | Get
          Booked Solid | SoftRanch
        </title>
        <meta
          name="description"
          content="Transform your medical practice with HIPAA-compliant website development and patient portals. Increase new patient inquiries by 50%, reduce administrative burden, and dominate local medical search. Trusted by 400+ healthcare providers."
        />
        <meta
          name="keywords"
          content="medical website development, HIPAA compliant websites, patient portal development, medical SEO, healthcare website design, telehealth integration, doctor website, medical practice marketing"
        />
        <meta
          property="og:title"
          content="Medical Website Development & HIPAA-Compliant Patient Portals | SoftRanch"
        />
        <meta
          property="og:description"
          content="Attract 50% more patients with HIPAA-compliant medical websites and patient portals. Professional healthcare web development."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "HIPAA-compliant medical website development with patient portals, appointment booking, and medical SEO for healthcare providers.",
            provider: {
              "@type": "Organization",
              name: "SoftRanch",
          ...
          <div className="healthcare-container">
            <div className="healthcare-hero-content">
              ...
              <p className="healthcare-hero-description">
                Build trust and attract more patients with HIPAA-compliant
                websites designed for healthcare professionals. Includes secure
                online appointment booking, patient portals, telehealth
                integration, and medical SEO that helps patients find your
                practice when they need care most.
              </p>
            ...
            <div className="healthcare-hero-image">
              <img
                src={img1}
                alt="Modern medical practice dashboard showing HIPAA-compliant patient portal and appointment booking system"
              />
          ...
          <div className="healthcare-container">
            <div className="healthcare-section-header">
              ...
              <p className="healthcare-section-subtitle">
                From HIPAA-compliant patient portals to telehealth integration,
                we provide the complete healthcare digital ecosystem that
                enhances patient care and practice efficiency.
              </p>
            </div>
            ...
            <div className="healthcare-features-grid">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="healthcare-feature-card"
                  data-index={index}
                >
                  <div className="healthcare-feature-icon">{feature.icon}</div>
                  <h3 className="healthcare-feature-title">{feature.title}</h3>
                  <p className="healthcare-feature-description">
                    {feature.description}
                  </p>
                </div>
              ))}
          ...
          <div className="healthcare-container">
            <div className="healthcare-benefits-content">
              <div className="healthcare-benefits-text">
                ...
                <p className="healthcare-section-subtitle">
                  We understand the unique challenges of healthcare marketing
                  and compliance. Our solutions are specifically designed to
                  help medical practices attract more patients while maintaining
                ...
                <div className="healthcare-benefits-list">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="healthcare-benefit-item">
                      <div className="healthcare-benefit-icon">
                        {benefit.icon}
                      </div>
                      <div className="healthcare-benefit-content">
                        <h3 className="healthcare-benefit-title">
                          {benefit.title}
                        </h3>
                        <p className="healthcare-benefit-description">
                          {benefit.description}
                        </p>
                      </div>
                    </div>
              ...
              <div className="healthcare-benefits-image">
                <img
                  src={img2}
                  alt="Doctor using tablet to manage patient appointments and medical records in modern clinic"
                />
              </div>
            </div>
          </div>
          ...
          <div className="healthcare-container">
            ...
            <div className="healthcare-packages-grid">
              {servicePackages.map((pkg, index) => (
                <div
                  key={index}
                  className={`healthcare-package-card ${
                    pkg.popular ? "healthcare-package-popular" : ""
                  }`}
                >
                  {pkg.popular && (
                  ...
                  <div className="healthcare-testimonial-rating">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        size={20}
                        className="healthcare-star-filled"
                      />
                    ))}
                  </div>
                  <p className="healthcare-testimonial-text">
                    "{testimonial.text}"
                  </p>
                  <div className="healthcare-testimonial-author">
                    <h4 className="healthcare-author-name">
                      {testimonial.name}
                    </h4>
                    <p className="healthcare-author-title">
                      {testimonial.title}
                    </p>
                  </div>
                </div>
          ...
          <div className="healthcare-container">
            <div className="healthcare-cta-content">
              ...
              <p className="healthcare-cta-description">
                Join 400+ successful healthcare providers who've dramatically
                increased their patient base and streamlined their practice
                operations with our HIPAA-compliant solutions.
              </p>
              ...
              <div className="healthcare-cta-guarantee">
                <CheckCircle size={20} />
                <span>
                  30-day money-back guarantee • HIPAA compliance included • Free
                  consultation
                </span>
              </div>
            </div>
